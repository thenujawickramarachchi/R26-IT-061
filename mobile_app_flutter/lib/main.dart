...
final Map<String, TextEditingController> controllers = {
  ...
  'week': TextEditingController(text: '20'),
  'month': TextEditingController(text: '5'),
  'temp_max_c': TextEditingController(text: '31.2'),
  'temp_min_c': TextEditingController(text: '25.4'),
  'temp_mean_c': TextEditingController(text: '28.3'),
  'feelslikemax': TextEditingController(text: '36.0'),
  'feelslikemin': TextEditingController(text: '27.0'),
  'feelslike': TextEditingController(text: '31.2'),
  'dew': TextEditingController(text: '24.5'),
  'humidity_pct': TextEditingController(text: '82.0'),
  'rainfall_mm': TextEditingController(text: '45.0'),
  'precipprob': TextEditingController(text: '80.0'),
  'precipcover': TextEditingController(text: '12.0'),
  'wind_speed_kmh': TextEditingController(text: '15.3'),
  'winddir': TextEditingController(text: '210.0'),
  'sealevelpressure': TextEditingController(text: '1010.0'),
  'cloudcover': TextEditingController(text: '75.0'),
  'visibility': TextEditingController(text: '9.5'),
  'solarradiation': TextEditingController(text: '180.0'),
  'solarenergy': TextEditingController(text: '15.0'),
  'uvindex': TextEditingController(text: '6.0'),
};
  @override
  void dispose() {
